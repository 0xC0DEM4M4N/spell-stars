...
export const SiteHeader = () => {
  ...
  return (
    <header className="material-bar fixed inset-x-0 top-0 z-50" data-scrolled={scrolled} data-testid="site-header">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-8">
        <Link to="/" className="font-display text-lg font-extrabold tracking-tight text-foreground" aria-label="SPELL// STARS home">
          SPELL<span className="text-primary">//</span>
          <span className="text-primary">
            ST<Star className="inline-block h-[0.85em] w-[0.85em] text-amber-400 drop-shadow-[0_0_10px_rgba(251,191,36,0.8)]" style={{ verticalAlign: "-0.12em" }} aria-hidden="true" />RS
          </span>
        </Link>
